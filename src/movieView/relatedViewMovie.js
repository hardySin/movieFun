...
export default function RelatedViewMovies(props)
{
      //  const query = useLocation();
    let { relatedID ,displayName} = useParams();
...
{
    let movielink="https://api.themoviedb.org/3/movie/"+relatedID+"?api_key=0612d44670c9d53eb57dd9ec885631d6&language=en-US";
...
{
    let movielink="https://api.themoviedb.org/3/movie/"+relatedID+"/credits?api_key=0612d44670c9d53eb57dd9ec885631d6";
    await fetch(movielink)
           .then(res => res.json())
          .then(res =>  
            {
...
{
    let movielink="https://api.themoviedb.org/3/movie/"+relatedID+"/videos?api_key=0612d44670c9d53eb57dd9ec885631d6&language=en-US";
    await fetch(movielink)
           .then(res => res.json())
          .then(res =>  
            {
...
//  event.target.pauseVideo();
 ...
 >  
        ...
        <h1 className="Acctitle">Similar Movies</h1>
                     <hr className="line"/>
            <RelatedMovies movieId={relatedID}  name={displayName}></RelatedMovies>
                     </Col>
        </Row>
              </>
      )
